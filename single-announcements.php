                                ...
                                <div>
                                    ...
                                    <div class="flex flex-wrap items-center gap-4 text-sm text-gray-600">
                                        <div class="flex items-center gap-2">
                                            <?php echo get_service_icon_svg('calendar', 'w-4 h-4 mr-1 text-orange-500') ?>
                                            <span>Posted on <?php echo get_the_date('F j, Y'); ?></span>
                                        </div>

                                        <?php if ($expiry_date): ?>
                                            <div class="flex items-center gap-2">
                                                <?php echo get_service_icon_svg('clock', 'w-4 h-4 mr-1 text-orange-500') ?>
                                                <span>Expires on
                                        ...
                                        <?php if ($priority): ?>
                                            <div class="flex items-center gap-2">
                                                <?php echo get_service_icon_svg('triangle-alert', 'w-4 h-4 mr-1 text-orange-500') ?>
