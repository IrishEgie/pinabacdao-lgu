            ...
            <div class="flex gap-8">
                ...
                <div class="w-full">
                    ...
                    <div class="space-y-4 p-4 bg-white rounded-lg border shadow-sm mb-6">
                        <!-- Search Field -->
                        <form method="get" action="<?php echo esc_url(get_post_type_archive_link('document')); ?>"
                            id="document-filters-form">
                            <div class="relative">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 mt-4">
                                ...
                                if ($has_active_filters):
                                    ...
                                    <div class="flex-1 sm:flex-none">
                                        <a href="<?php echo esc_url(get_post_type_archive_link('document')); ?>"
                        ...
                        <!-- Results Summary -->
                        <div
                            class="flex items-center justify-between text-sm text-gray-600 pt-3 border-t border-gray-200">
                                ...
                                foreach ($grouped_documents as $type_name => $documents):
                                    ...
                                    <div class="accordion-item">
                                            ...
                                            <button type="button"
                                                ...
                                                <div class="flex items-center justify-between w-full pr-4">
                                                    ...
                                                    <span
                                                        ...
                                                        document<?php echo count($documents) !== 1 ? 's' : ''; ?>
                                                    </span>
                                                </div>
                                        ...
                                        <div id="<?php echo $accordion_id; ?>"
                                            class="accordion-content <?php echo $is_single_type ? '' : 'hidden'; ?>">
                                            <div class="border-t border-gray-100">
                                                <?php foreach ($documents as $index => $document):
                                                    ...
                                                    ?>
                                                    <div
                                                        class="group transition-colors duration-150 ease-in-out <?php echo $index > 0 ? 'border-t border-gray-100' : ''; ?>">
                                                        <div class="flex flex-col lg:flex-row lg:items-center gap-4 p-6 hover:bg-gray-50 cursor-pointer"
                                                            ...
                                                            <div class="flex-1 min-w-0">
                                                                <h4
                                                                    class="text-lg font-semibold text-gray-900 group-hover:text-primary-700 transition-colors leading-tight">
                                                                    <?php echo esc_html($document['title']); ?>
                                                                    <?php if ($document_number): ?>
                                                                        <span
                                                                            class="text-gray-500 font-normal text-base ml-2">(<?php echo esc_html($document_number); ?>)</span>
                                                                    <?php endif; ?>
                                                                </h4>
                                                                ...
                                                                <div class="flex flex-wrap gap-4 mt-2 text-sm text-gray-600">
                                                                    <?php if ($date_issued): ?>
                                                                        <span class="flex items-center gap-1">
                                                                            ...
                                                                            Issued:
                                                                            <?php echo date('M j, Y', strtotime($date_issued)); ?>
                                                                        </span>
                                                                    <?php endif; ?>
                                                                    <?php if ($date_effective && $date_effective !== $date_issued): ?>
                                                                        <span class="flex items-center gap-1">
                                                                            ...
                                                                            Effective:
                                                                            <?php echo date('M j, Y', strtotime($date_effective)); ?>
                                                                        </span>
                                                                    <?php endif; ?>
                                                                    <?php if ($office_name): ?>
                                                                        <span class="flex items-center gap-1">
                                                            ...
                                                            <div class="flex-shrink-0 flex items-center gap-2">
                                                                <span
                                                                    class="inline-flex items-center gap-2 px-4 py-2 border border-transparent text-sm font-medium rounded-md text-primary-700 bg-primary-100 group-hover:bg-primary-200 group-hover:text-primary-800 transition-colors">
                                                                    <?php if ($is_external): ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-12 text-center">
                            ...
                            <p class="text-gray-600 mb-6">
                                We couldn't find any documents matching your current filters. Try adjusting your search
                                criteria.
                            </p>
                            <a href="<?php echo esc_url(get_post_type_archive_link('document')); ?>"
