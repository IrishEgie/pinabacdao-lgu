                ...
                <div class="space-y-6">
                    <?php if(get_field('mandate')): ?>
                        <div>
                            ...
                            <div class="prose prose-gray max-w-none"><?php the_field('mandate'); ?></div>
                        </div>
                    <?php endif; ?>
                    <?php if(get_field('functions')): ?>
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 mb-2">Key Functions</h3>
                            <div class="prose prose-gray max-w-none"><?php the_field('functions'); ?></div>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            <div class="p-8">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <img src="<?php echo get_field('organizational_structure')['url']; ?>" alt="Organizational Chart of <?php the_title(); ?>" class="w-full h-auto mx-auto">
                </div>
            </div>
        </div>
    <?php endif; ?>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="p-8">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex-shrink-0 w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center text-gray-400">
                            <?php echo display_service_icon('users', 'w-8 h-8'); ?>
                        </div>
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800"><?php echo get_field('department_head')->post_title; ?></h3>
                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="text-center p-4 bg-gray-50 rounded-lg">
                            <p class="text-3xl font-bold text-primary-600"><?php the_field('employee_count_regular'); ?></p>
                            <p class="text-sm text-gray-600">Regular</p>
                        </div>
                        <div class="text-center p-4 bg-gray-50 rounded-lg">
                            <p class="text-3xl font-bold text-primary-600"><?php the_field('employee_count_casual'); ?></p>
                            <p class="text-sm text-gray-600">Casual</p>
                        </div>
                        <div class="text-center p-4 bg-gray-50 rounded-lg">
                            <p class="text-3xl font-bold text-primary-600"><?php the_field('employee_count_job_order'); ?></p>
                    ...
                    <?php while(have_rows('divisions')): the_row(); ?>
                        <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <h3 class="text-lg font-semibold text-gray-800"><?php the_sub_field('division_name'); ?></h3>
                            </div>
            ...
            <div class="p-8">
                ...
                <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                        ...
                        <a href="<?php echo get_field('citizens_charter')['url']; ?>" class="text-primary-600 hover:text-primary-700 text-sm font-medium inline-flex items-center mt-1" download>
                            Download PDF
            ...
            <div class="p-8">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <?php foreach(get_field('related_services') as $service): ?>
                        <a href="<?php echo get_permalink($service->ID); ?>" class="group flex items-center gap-4 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                            <div class="flex-shrink-0 w-10 h-10 bg-primary-100 text-primary-600 rounded-full flex items-center justify-center">
                                <?php 
                            ...
                            <div>
                                <h3 class="font-medium text-gray-800 group-hover:text-primary-600 transition-colors"><?php echo $service->post_title; ?></h3>
                                <p class="text-sm text-gray-500"><?php echo wp_trim_words(get_the_excerpt($service->ID), 10); ?></p>
                            </div>
                        </a>
                    <?php endforeach; ?>
                </div>
