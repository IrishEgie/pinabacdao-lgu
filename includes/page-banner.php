...
if (!function_exists('pageBanner')) {
    ...
    function pageBanner($args = [])
    {
        ...
        $defaults = [
            'title' => get_the_title(),
            'subtitle' => 'Dont forget to update this subtitle',
            'description' => '',
            'background_image' => 'https://images.unsplash.com/photo-1746928503465-c9e98b69211e?q=80&w=1720&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
