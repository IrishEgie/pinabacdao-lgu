 ...
 * Description: WordPress template for News post type archive
 */
                                        ...
                                        <div class="p-6 hover:bg-gray-50 transition duration-150 ease-in-out">
                                            <div class="flex flex-col md:flex-row md:items-center gap-4">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <h3
                                                        class="font-bold text-gray-600 group-hover:text-primary-600 transition duration-150 ease-in-out">
                                                        <?php the_title(); ?>
                                                    </h3>
